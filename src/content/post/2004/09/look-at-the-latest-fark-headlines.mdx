...
But running this doesn’t quite get the result I was looking for.
I just want the headlines, and I want them without the HTML, thank you very much.

Fark and a lot of other news sites make [RSS][rss] feeds available.
These are special XML files containing mainly -
you guessed it, the headlines, without the HTML, you’re very welcome.
...
Now I get the RSS file dumped to the console.
At least the story headlines are little easier to find.
To get the behavior I want, though,
we’re going to need to chop out the bits we don’t care about and get straight to the headlines.
This task is straightforward in Ruby, thanks to the [RSS][ruby-rss] library.
The RSS library has recently been made an official part of the standard libs,
which makes a lot of this exercise much easier.

[ruby-rss]: https://ruby-doc.org/stdlib-3.0.2/libdoc/rss/rdoc/RSS.html
...
[OptionParser][option-parser] is a great class for handling command-line arguments.

[option-parser]: https://ruby-doc.org/stdlib-3.0.1/libdoc/optparse/rdoc/OptionParser.html
