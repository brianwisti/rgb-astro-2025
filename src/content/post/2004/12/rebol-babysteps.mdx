...
Right.
Here is this language that you’ve never heard of:
...
And remember to just ignore people when they ask you
"Why should I learn REBOL (or Perl, or Python, or Ruby) instead of Perl (or Python, or Ruby, or Java)?"
You and I are the sort of people who learn a language *in addition* to the ones we already know, not *instead of* the one we were
taught in college.
