...
categories:
  - post
cover_caption: My h-card as of a few minutes ago
cover_image: /img/2020/cover-indieweb-h-cards.png
...
in Python that I prefer explicit to implicit when
practical.
...
microformats2
[prefixes](https://microformats.org/wiki/microformats2-prefixes) confuse
me, but they have a consistent pattern and rules for
[parsing](https://microformats.org/wiki/microformats2-parsing).
...
![simple h-card screenshot](@img/2020/hcard-photo.png "h-card with bio and photo")
...
Use [me](https://microformats.org/wiki/rel-me) to tell people that this
link is also about you. It’s a way to
[consolidate](https://microformats.org/wiki/identity-consolidation) the
...
![screenshot of Mastodon profile page](@img/2020/hackers-town-profile.png
...
![screenshot of indielogin.com authentication](@img/2020/indielogin-auth.png
...
![screenshot of updated h-card](@img/2020/hcard-relme.png "Now my name links to my `u-uid`")
...
![image](@img/2020/hcard-details.png "Some styling distinguishes identity links from details")
...
![mf2 validator JSON output screenshot](@img/2020/mf2-validator.png
...
![IndieWebify.me h-card suggestion screenshot](@img/2020/validated-hcard.png "IndieWebify.me h-card summary")
...
[Martijn van der Ven's h-card](https://vanderven.se/martijn/)
