...
categories:
  - post
cover_image: /img/2020/cover-sort-of-tufte-css.png
...
Of course, I had to adjust the original CSS for my own quirks.
Added more [Fork Awesome](https://forkaweso.me/) icons.
Made the [RST][rst] elements fit.
Tips from a [David Walsh post](https://davidwalsh.name/external-links-css) helped me show external links.
