...
categories:
  - post
cover_image: /img/2018/cover-setting-task-dependencies-in-taskwarrior.png
...
I use [Priority][priority] to show what I’m reading right now. The highest
priority goes to the book which I intend to finish next.
...
![fosscontrib project with one dependency set](@img/2018/single-dependency.png)
...
![taskwarrior report](@img/2018/cover-setting-task-dependencies-in-taskwarrior.png
