...
categories:
  - post
cover_image: /img/2018/cover-trying-beorg.png
...
This is me, excitedly sharing screenshots of the shiny thing I am playing with.
...
![Emacs showing task added in beorg](@img/2018/emacs-synced.png)
...
![TODO view](@img/2018/agenda-view.png)
...
![Filtered TODO view](@img/2018/agenda-filtered.png)

## Notifications

The app icon badge shows the count of overdue tasks.

![Overdue count shown on app icon](@img/2018/notifications.jpg)

Alarms pop up for deadlines.

![Task notification](@img/2018/alarm.png)
