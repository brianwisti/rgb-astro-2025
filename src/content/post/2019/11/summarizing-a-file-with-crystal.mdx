...
categories:
  - post
cover_image: /img/2019/cover-summarizing-a-file-with-crystal.png
date: 2019-11-17 00:00:00-08:00
description: Been busy, but let's take a minute to summarize a file's details with Crystal
draft: false
posse:
  - https://hackers.town/@randomgeek/103152258645062862
tags:
  - files
uses:
  - crystal
...
Okay, I don’t have a lot of time here.
We’re on a tight schedule.
But hey tests are running so I’ll write a tiny bit of [Crystal][crystal].

[crystal]: https://crystal-lang.org

How would I print a quick summary of a file? Besides
[`ls`](https://www.man7.org/linux/man-pages/man1/ls.1.html), of course. I
