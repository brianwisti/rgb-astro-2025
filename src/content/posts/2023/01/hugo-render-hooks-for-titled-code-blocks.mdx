...
categories:
  - post
cover_caption: an illustrative example
cover_image: /img/2023/cover-hugo-render-hooks-for-titled-code-blocks.png
date: 2023-01-19 16:02:04-08:00
description: |
  Captions more than titles, really. No problem. We'll fix it in post.
draft: false
posse:
  - https://www.linkedin.com/posts/brianwisti_hugo-render-hooks-for-titled-code-blocks-activity-7022000696434556928-PSRJ
  - https://hackers.town/@randomgeek/109718751383178761
tags:
  - ssg
uses:
  - hugo
...
That's been possible with Hugo since 0.93.0, using [render hooks][render-hook].
...
````markdown title="Titled code block"
```html{title="layouts/_default/render-codeblock.html"}
````
...
````markdown title="non-verbatim code block title"
