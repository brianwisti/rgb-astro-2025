---
aliases:
  - /post/2020/11/using-the-webmentionio-api/
categories:
  - post
cover_caption: A spiderweb! For Webmention! Get it? Okay, yeah. Sorry.
cover_image: /img/2020/cover-using-the-webmentionio-api.jpg
date: 2020-11-10 00:00:00-08:00
description: Fetching my IndieWeb mentions with HTTPie and Requests
draft: false
posse:
  - https://hackers.town/@randomgeek/105185266968641437
series:
...
mode][adding-a-note-from-org-mode].
...
[adding-a-note-from-org-mode]: /post/2020/10/i-added-this-note-from-org-mode/
...
[again]: /post/2020/05/querying-hugo-content-with-python/
