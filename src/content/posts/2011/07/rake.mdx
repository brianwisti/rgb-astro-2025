...
It is written in [Ruby][ruby], but is useful in far more than just Ruby projects.
...
[rake-intro]: https://web.archive.org/web/20220925013740/http://stuartellis.eu/articles/rake/

:::note

This is not going to be an in-depth Rake tutorial.
I’ve noticed a lack of simple real-world Rakefile examples, aside from one excellent [Rake introduction][rake-intro].
I have a Rakefile I need to build.
...
I have a shortcut set up in [Vim][vim] that invokes Rake with a default argument.
...
I will take advantage of the [syncftp][syncftp] Ruby library,
