...
- /post/2005/01/perl-5-babysteps-01-getting-started/
categories:
- post
...
[perlbrew]: /post/2011/09/perlbrew/
[windows]: https://www.microsoft.com/en-us/windows

Okay.
Everybody not on [Microsoft Windows][windows], go install [Perlbrew][perlbrew].
