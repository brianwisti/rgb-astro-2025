---
aliases:
- /post/2021/08/extracting-rich-output/
categories:
- post
cover_caption: a screenshot of the HTML that I created to show I don't need screenshots
cover_image: /img/2021/cover-extracting-rich-output.png
date: 2021-08-24 15:08:00-07:00
description: Okay maybe not so much on the profit but definitely fun!
draft: false
posse:
- https://hackers.town/@randomgeek/106813401148510776
- https://twitter.com/brianwisti/status/1430292573315342336
tags:
- python
- rich
- tools
...
:::note{title="2021-08-25"}
I initially posted a version of this post using [BeautifulSoup][bs4] for HTML
extraction. Then Rich creator [Will McGugan][will-mcgugan] pointed out that I could get
what I need from Rich itself!

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Great write up!<br /><br />You may be able to skip the Beautiful Soup step with the following:<br /><br />console.export_html(code_format=&quot;&lt;pre style=&quot;font-family:Menlo,&#39;DejaVu Sans Mono&#39;,consolas,&#39;Courier New&#39;,monospace&quot;&gt;&lbrace;code&rbrace;&lt;/pre&gt;&quot;)</p>&mdash; Will McGugan (@willmcgugan) <a href="https://twitter.com/willmcgugan/status/1430452309536956421?ref_src=twsrc%5Etfw">August 25, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
![table output](@img/2021/showstats-table.png "table output")
...
<pre><span style="font-style: italic">                    Plausible.io Traffic Breakdown                    </span><br/>
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━┓<br/>
┃<span style="font-weight: bold"> Page                                                    </span>┃<span style="font-weight: bold"> Visitors </span>┃<br/>
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━┩<br/>
│ /post/2017/11/drawing-grids-with-python-and-pillow/     │<span style="color: #008000; text-decoration-color: #008000">    1,114 </span>│<br/>
│ /post/2017/01/cinnamon-screenshot-shortcuts/            │<span style="color: #008000; text-decoration-color: #008000">      580 </span>│<br/>
│ /                                                       │<span style="color: #008000; text-decoration-color: #008000">      458 </span>│<br/>
│ /post/2014/06/what-is-build-essentials-for-opensuse/    │<span style="color: #008000; text-decoration-color: #008000">      340 </span>│<br/>
│ /config/emacs/doom/                                     │<span style="color: #008000; text-decoration-color: #008000">      303 </span>│<br/>
│ /post/2020/06/csv-and-data-tables-in-hugo/              │<span style="color: #008000; text-decoration-color: #008000">      293 </span>│<br/>
│ /post/2019/05/kitty-terminal/                           │<span style="color: #008000; text-decoration-color: #008000">      265 </span>│<br/>
│ /post/2018/02/setting-task-dependencies-in-taskwarrior/ │<span style="color: #008000; text-decoration-color: #008000">      263 </span>│<br/>
│ /post/2019/02/taskwarrior-projects/                     │<span style="color: #008000; text-decoration-color: #008000">      260 </span>│<br/>
│ /post/2019/01/circular-grids-with-python-and-pillow/    │<span style="color: #008000; text-decoration-color: #008000">      242 </span>│<br/>
└─────────────────────────────────────────────────────────┴──────────┘</pre>
...
/* markdownlint-disable-next-line MD053 */
[console-export]: https://rich.readthedocs.io/en/stable/console.html#exporting
