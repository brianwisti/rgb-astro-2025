...
draft: false
posse:
- https://hackers.town/@randomgeek/106869016960143724
tags:
- markdown
- python
- javascript
...
Nikola blog idea that was distracting me from an attempt at porting my
...
Could probably even use it in {{< tag "hugo" >}} if I make another
[neovim plugin][neovim-plugin] for `.md.txt` files.

{% note %}
Oh heck. I added a [bookmark][] for MyST's Jupyter Book parent project not long
ago.  BRB adding a "markdown" tag.

[bookmark]: /post/2021/01/jupyterbook-org/
{% /note %}
