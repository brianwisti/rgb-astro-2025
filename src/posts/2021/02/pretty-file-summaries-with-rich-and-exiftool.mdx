...
categories:
- post
cover_caption: Hoku hopes for scraps
cover_image: /img/2021/cover-pretty-file-summaries-with-rich-and-exiftool.jpg
date: 2021-02-06 00:00:00-08:00
description: Want to see something cool?
draft: false
posse:
- https://dev.to/brianwisti/post-pretty-file-summaries-with-rich-and-exiftool-2afn
- https://hackers.town/@randomgeek/105687357346007063
- https://twitter.com/brianwisti/status/1358225248106262529
tags:
- files
- python
- tools
...
MDX-in-Astro giving me grief about the multiline `pre` block I got down here.
I'll wrap it like code so you can see the raw markup, and add a task to fix it someday.
:::

```html
<pre><span style="font-weight: bold">&lbrace;</span>
...
```html
<pre class="rich"><span style="font-weight: bold">&;brace;</span>
...
<span style="font-weight: bold">&rbrace;</span></pre>
```
...
:::note{title="2024-12-30"}
sigh.
How unexpected corner is always very broken when I shift to a new SSG.
:::
