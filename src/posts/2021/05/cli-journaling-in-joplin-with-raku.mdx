---
aliases:
- /post/2021/05/cli-journaling-in-joplin-with-raku/
categories:
- post
cover_caption: the formatted output of my journal-reading one-liner
cover_image: /img/2021/cover-cli-journaling-in-joplin-with-raku.png
date: 2021-05-21 00:00:00-07:00
description: I sure do use a lot of words to justify my one-liners
draft: false
posse:
- https://hackers.town/@randomgeek/106277084642441342
- https://twitter.com/brianwisti/status/1395967937224314881
series:
...
![Editing a journal entry](@img/2021/editing-note.png)
...
MDX-in-Astro keeps biting me for all the old Rich HTML export.
For now I wrap the output in a `pre` block.
At least you can see the generated markup.
:::
...
That's a single [`.subst`][subst] transformation.
