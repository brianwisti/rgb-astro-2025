---
aliases:
- /post/2021/05/joplin-cli-batch-processing-with-raku/
categories:
- post
cover_caption: don't get excited; these are the only notes I took
cover_image: /img/2021/cover-joplin-cli-batch-processing-with-raku.jpg
date: 2021-05-24 20:00:00-07:00
description: In which a minor update veers off on a Raku regex tangent
draft: false
posse:
- https://hackers.town/@randomgeek/106293702059312426
- https://twitter.com/brianwisti/status/1397031312209465346
series:
...
Don't ask me to understand the shell magic.  In [GNU Bash][bash], `command <(stuff)` means something along the lines of "evaluate *stuff* and hand the
...
![diagram of multi-line string showing where these anchors match](@img/2021/regex-anchors.jpg)
