...
- /post/2017/01/cinnamon-screenshot-shortcuts/
categories:
- post
cover_image: /img/2017/cover-cinnamon-screenshot-shortcuts.png
...
:::note{title="Keyboard shortcuts for taking screenshots"}
...
![fullscreen screenshot](@img/2017/cinnamon-fullscreen-screenshot.png "Fullscreen screenshot, scaled down")

## Take A Screenshot Of A Window

`Alt + Print` together to save a single window.

![window screenshot](@img/2017/cinnamon-window-screenshot.png "Window screenshot, scaled down")
...
![area screenshot](@img/2017/cinnamon-area-screenshot.png "An area on the Linux Mint home page")
