...
- /post/2017/11/drawing-grids-with-python-and-pillow/
categories:
- post
cover_image: /img/2017/cover-drawing-grids-with-python-and-pillow.png
...
![A blank image](@img/2017/grid-blank.png)
...
![Drawing one line](@img/2017/grid-single-line.png)
...
![Drawing some columns](@img/2017/grid-columns.png)
...
![Drawing a simple grid](@img/2017/grid-simple-grid.png)
...
![Specifying a step count](@img/2017/grid-step-count.png)
...
![Grabbing a step count from the command line](@img/2017/grid-specify-step-count.png)
...
![Constructing grid from Argparse arguments](@img/2017/grid-specify-size-steps.png)
...
![Rectangular grid](@img/2017/grid-rectangular.png)

[image-class]: http://pillow.readthedocs.io/en/4.3.x/reference/Image.html#the-image-class

Hold on. I was handing `height` and `width` to [Image][image-class] in the
...
![Correct Image initialization](@img/2017/grid-correct-image-init.png)
