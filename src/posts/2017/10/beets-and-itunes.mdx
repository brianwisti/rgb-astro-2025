...
draft: false
posse:
- https://twitter.com/brianwisti/status/914570723456200704
tags:
- music
- macos
- beets
...
[beets-plugins]: http://beets.readthedocs.io/en/v1.4.5/plugins/index.html

[Plugins][beets-plugins] allow beets to perform more than media management. I won’t talk
...
```yaml title="~/.config/beets/config.yaml"
...
[doug-scripts]: https://dougscripts.com/itunes/index.php#whatsnew
[ask-different]: https://apple.stackexchange.com/questions/202504/searching-itunes-library-for-file-location#222834

I rarely use [AppleScript][applescript], so it took a combination of Web
searching and guesswork to come up with this. [This post][] from [Doug's
AppleScripts for iTunes][doug-scripts] blog and this [Ask Different
answer][ask-different] got me most of the way there. The guesswork finished it
off.

```applescript title="~/bin/iTunesRefresh.scpt"
on run (argv)
...
![Editing a Beets entry in Vim](@img/2017/beet-edit-screen.png)
...
```sql title="sqlite3 ~/.config/beets/library.db"
