...
categories:
- post
cover_image: /img/2017/cover-logging-money-in-org-mode.png
...
![menu 1 for money capture](@img/2017/org-capture-menu-1.png "`C-c c` to enter org capture menu")

![menu 2 for money capture](@img/2017/org-capture-menu-2.png "`p` then `m` for a Personal Money entry")
...
![Finalize capture buffer](@img/2017/org-money-capture-buffer.png "`C-c C-c` to finalize")
...
![Filtered on money](@img/2017/agenda-filter-money.png "`C-c a m money` to filter on the `:money` tag")
...
![Filtered on income](@img/2017/agenda-filter-income.png "`C-u r income` to filter on the `:income:` tag")
...
![Filtered on expense](@img/2017/agenda-filter-expense.png "`C-u r expense` to filter on the `:expense:` tag")
