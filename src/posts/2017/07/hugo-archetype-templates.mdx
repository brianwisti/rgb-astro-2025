...
- /post/2017/07/hugo-archetype-templates/
categories:
- post
cover_image: /img/2017/cover-hugo-archetype-templates.png
date: 2017-07-01 00:00:00-07:00
draft: false
posse:
- https://twitter.com/brianwisti/status/881595135540080640
tags:
- hugo
- site
- bash
...
content. Hugo allows both default archetypes and [section archetypes][section]
for content that belongs in a particular section (such as Posts or Crafts).
...
```markdown title="archetypes/default.md"
---
