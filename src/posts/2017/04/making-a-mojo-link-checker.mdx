...
- /post/2017/04/making-a-mojo-link-checker/
categories:
- post
date: 2017-04-11 00:00:00-07:00
draft: false
posse:
- https://twitter.com/brianwisti/status/851963025850474496
tags:
- perl
- site
- mojolicious
...
[config-format]: http://gohugo.io/overview/configuration/
...
Hugo’s built-in support for different [configuration format][config-format] made that a painless shift.
...
[one page]: /post/2014/10/blog-writing-in-org-mode/
