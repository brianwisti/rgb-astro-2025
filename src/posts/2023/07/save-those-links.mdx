...
Plain old link rot prompted my [#PKM](https://ack.cringe.cafe/tag/pkm) habits.
...
Browser extensions such as [MarkDownload](https://github.com/deathau/markdownload) can grab page content to paste into Markdown-friendly note tools like [#ObsidianMD](https://ack.cringe.cafe/tag/obsidianmd) and [#Logseq](https://ack.cringe.cafe/tag/logseq).
