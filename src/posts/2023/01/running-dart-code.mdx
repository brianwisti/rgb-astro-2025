...
categories:
- post
date: 2023-01-17 15:06:33-08:00
description: Learning to run Dart so I can walk with it — or something
draft: false
posse:
- https://www.linkedin.com/posts/brianwisti_running-dart-code-activity-7021252805109682176-QyaP
- https://hackers.town/@randomgeek/109707071684294418
tags:
- dart
...
| `js`          |JavaScript |yes|yes|
 ...
 use [webdev](https://dart.dev/tools/webdev) instead for JS targets
...
![The same output, with red bold text for the user prompt](@img/2023/dcli-dart-run.png)
