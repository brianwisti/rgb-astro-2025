...
categories:
- note
cover_caption: A bullet point is a note given the right tag
cover_image: /img/2023/cover-emulate-tldr-in-your-notes.png
date: 2023-01-31 07:30:32-08:00
draft: false
posse:
- https://www.linkedin.com/posts/brianwisti_logseq-secondbrain-blog-activity-7026211616236982272-jRco
- https://hackers.town/@randomgeek/109784550162499793
tags:
- logseq
- second-brain
...
[tldr-tar]: https://tldr.inbrowser.app/pages/common/tar
...
![Logseq search results with example bullets at top of the list](@img/2023/2023-01-31-rclone-search.png "There it is!")
