...
- /post/2019/02/taskwarrior-projects/
categories:
- post
cover_image: /img/2019/cover-taskwarrior-projects.png
date: 2019-02-16 00:00:00-08:00
description: Use Taskwarrior projects to organize closely related tasks!
draft: false
posse:
- https://twitter.com/brianwisti/status/1096968817358471168
series:
...
![task report filtered to cards project](@img/2019/task-project-cards.png)
...
![task projects listing](@img/2019/task-projects.png)
...
![task projects listing with a subproject](@img/2019/task-projects-with-subproject.png)
...
![task summary](@img/2019/task-summary.png)
