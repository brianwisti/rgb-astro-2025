...
- /post/2019/05/kitty-terminal/
categories:
- post
cover_image: /img/2019/cover-kitty-terminal.png
date: 2019-05-27 00:00:00-07:00
description: I installed kitty for font ligatures in terminals on Linux, but it does
  other stuff too.
posse:
- https://hackers.town/@randomgeek/102167342505236721
- https://twitter.com/brianwisti/status/1132944399011405825
tags:
- shell
- kitty
- tools
...
![Fira Code ligatures](@img/2019/all_ligatures.png)
...
![GNOME trust dialog](@img/2019/gnome-trust.png)
...
![Ligatures when looking at Mojolicious source](@img/2019/mojolicious.png)
...
[rxvt](https://rxvt.sourceforge.net/) fast, but it’s much quicker than
what I’m used to.
...
![classic cat pics in the terminal!](@img/2019/kitty-icat.png)

::note
Over on Twitter, [Yanick Champoux](https://techblog.babyl.ca/) noted that
...
![Entering a unicode character by name in kitty](@img/2019/unicode-entry.png)
