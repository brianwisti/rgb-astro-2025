...
- /post/2019/05/pretty-print-terminal-files-with-bat/
categories:
- post
cover_image: /img/2019/cover-pretty-print-terminal-files-with-bat.png
date: 2019-05-24 00:00:00-07:00
description: '`bat` is like a fancier `cat` for displaying file contents.

  '
posse:
- https://hackers.town/@randomgeek/102153562058385171
- https://twitter.com/brianwisti/status/1132062293209092098
tags:
- shell
- tools
...
![The site Makefile — oh look a trailing space!](@img/2019/showing-whitespace.png)
...
![bat showing a plain text file](@img/2019/bat-plain-text.png)
