...
categories:
- post
cover_caption: Emacs Info (zoomed with `text-scale-adjust`)
cover_image: /img/2019/cover-installing-emacs-documentation-on-pop-os.png
date: 2019-12-01 11:11:00-08:00
description: Apt spells "emacs core docs" as "emacs-common-non-dfsg".
draft: false
posse:
- https://hackers.town/@randomgeek/103234200410596678
tags:
- emacs
- linux
