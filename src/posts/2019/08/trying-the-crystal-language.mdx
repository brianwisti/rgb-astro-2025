...
- /post/2019/08/trying-the-crystal-language/
categories:
- post
cover_image: /img/2019/cover-trying-the-crystal-language.png
date: 2019-08-25 00:00:00-07:00
description: In which I use Crystal for a simple shell task
posse:
- https://hackers.town/@randomgeek/102680987046371636
- https://twitter.com/brianwisti/status/1165817982104346624
tags:
- crystal
- taskwarrior
- programming
...
![Colorized JSON via jq](@img/2019/crystal-env-jq.png)
...
```crystal title="task-indicator.cr"
...
![Output of task-indicator.cr showing something due today](@img/2019/run-task-indicator.png)
