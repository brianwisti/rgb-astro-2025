...
- /post/2009/07/parrot-babysteps-02-variables-and-types/
categories:
- post
...
low-level nature of PIR. Those operators correspond to opcodes, and PIR only wants to see one opcode per statement. That's why the formula is broken down into distinct
steps.
{% /note %}
...
Now I can see the value described by `10` in decimal, octal, hex, and binary.
My life is complete.
...
There are many operators, but here are what I think of as the core operators
