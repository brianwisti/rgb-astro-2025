...
- /post/2009/07/parrot-babysteps-01-getting-started/
categories:
- post
...
simple variables, and input. PIR, the [Parrot Intermediate Representation](http://docs.parrot.org/parrot/latest/html/docs/book/pir/ch03_basic_syntax.pod.html) language, will be my
...
Take your browser to the [editor](https://github.com/parrot/parrot/tree/RELEASE_3_0_0/editor) directory for the latest stable Parrot release.
Download the files that are important for Vim support:
...
Create a `vimfiles` directory in your home folder if you don't already have one.
Using [README.pod](https://github.com/parrot/parrot/blob/RELEASE_3_0_0/editor/README.pod) as your guide, move the support files into your `vimfiles` directory:
...
Open `vimfiles\ftdetect\filetype_parrot.vim` and execute the following: `:4s/\.vim/vimfiles`
