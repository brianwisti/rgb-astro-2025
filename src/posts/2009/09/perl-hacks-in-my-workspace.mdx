...
- /post/2009/09/perl-hacks-in-my-workspace/
categories:
- post
...
* Open Protocols / URI Rewriting / Enable Smart Prefixes; use the space bar to expand the tree as you go.
* Select `[Edit]`
...
* Enter `o` to open the Options Manager
* Open Protocols / URI Rewriting / Smart Prefixes; use the space bar to expand the tree as you go.
* Select `[Add]`
