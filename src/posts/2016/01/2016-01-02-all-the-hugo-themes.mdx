...
- /post/2016/01/all-the-hugo-themes/
categories:
- post
cover_image: /img/2016/cover-all-the-hugo-themes.png
date: 2016-01-02 00:00:00-08:00
description: Using Python to preview my Hugo site with many themes
posse:
- https://twitter.com/brianwisti/status/683446375275560960
tags:
- hugo
- python
- programming
...
My site does well enough with [Hugo][hugo] and a custom theme, but I wanted to
explore the [themes repository][hugo-themes]. So I wrote some [Python][python].
...
[Splinter][splinter] provided the browser controlling API. Since I’m using
Chrome for this, I installed the [Chrome WebDriver][splinter-chrome]. The
[subprocess][subprocess] standard library module allowed me to control Hugo,
restarting with a fresh theme once the browser had enough time to grab a
screenshot.

[splinter]: https://splinter.readthedocs.org
[splinter-chrome]: https://splinter.readthedocs.org/en/latest/drivers/chrome.html
[subprocess]: https://docs.python.org/3.5/library/subprocess.html

Then I had a last minute idea: use the [convert][convert] utility from
[ImageMagick][image-magick] to collect all the screenshots into an animated
GIF.
...
GIF](/assets/img/2016/hugo-themes.gif) instead.
...
![Red Lounge theme screenshot](@img/2016/chrome-redlounge-medium.png
...
![Artists theme screenshot](@img/2016/chrome-artists-medium.png
...
![Pixyll theme screenshot](@img/2016/chrome-pixyll-medium.png
  "[Pixyll](https://themes.gohugo.io/pixyll) theme")

The themes seemed a little confused by my {{< tag "craft" >}} section. Some
ignored craft projects completely. Others integrated them with posts on the
`index.html` listing. Most at least provided a menu link to the section. And
yes, the theme `README` would likely remove my confusion.
...
![Hyde-X theme screenshot](@img/2016/chrome-hyde-x-medium.png
