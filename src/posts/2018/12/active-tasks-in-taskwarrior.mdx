...
- /post/2018/12/active-tasks-in-taskwarrior/
categories:
- post
cover_image: /img/2018/cover-active-tasks-in-taskwarrior.png
date: 2018-12-01 00:00:00-08:00
draft: false
posse:
- https://twitter.com/brianwisti/status/1069017480306147328
series:
...
:::note{title="TL;DR:"}
Use the `start`, `stop`, and `active` [Taskwarrior](https://taskwarrior.org/) commands to manage what you’re doing right now.
:::
