...
description: Using Ruby to create knotwork panel images
---
:::note{title="2020-08-01"}
...
```ruby title="knotwork/knotwork_panel.rb"
require "tile"
require "grid"
...
```ruby title="define-knotwork-panel-class"
...
```ruby title="tests/test_knotwork_panel.rb"
require "minitest/autorun"
...
```ruby title="knotwork-image-logic"
require 'rmagick'
include Magick
...
```ruby title="main-with-option-parsers"
def main
  rows = 1
  columns = 1
...
:::note
Me from the immediate future says "See? This is what I was talking about. You say "2 rows" and you get a 4x4 square? How do you think people are going to react? Man, I need more coffee."
:::
...
[you have been warned](/img/2004/panel-100x75.png)
:::
