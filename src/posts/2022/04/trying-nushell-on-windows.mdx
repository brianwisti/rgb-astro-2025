...
categories:
- post
cover_caption: Hugo's article list piped through multiple Nushell built-ins
cover_image: /img/2022/cover-trying-nushell-on-windows.png
date: 2022-04-22 21:15:00-07:00
description: They say I can run Nushell on Windows. Let's try that.
draft: false
posse:
- https://hackers.town/@randomgeek/108179615012858475
tags:
- nushell
- windows
- shell
...
![output of `ls` in Nushell on Windows](@img/2022/nu-win-initial-ls.png)
...
[fairy-floss]: https://sailorhg.github.io/fairyfloss/
...
![Nushell with Fairy Floss theme and a Starship prompt](@img/2022/nu-win-themed-starship.png)
...
[hugo-python]: /post/2020/05/querying-hugo-content-with-python/
