...
categories:
  - post
cover_caption: just the numbers
cover_image: /img/2022/cover-nanoc-builds-faster-with-3-2-0.png
date: 2022-12-25 11:00:00-08:00
description: Ain't no benchmark like an unscientific ad hoc benchmark
draft: false
posse:
  - https://hackers.town/@randomgeek/109576038838397555
tags:
  - benchmarking
  - nanoc
  - ruby
...
[benchmarking]: https://web.archive.org/web/20221228062802/https://www.solnic.dev/p/benchmarking-ruby-32-with-yjit
