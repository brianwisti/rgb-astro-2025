...
categories:
- post
cover_caption: If you think that's weird, you should see what all these emoji have
  done to my neovim session.
cover_image: /img/2022/cover-emoji-breakdowns-with-raku.png
date: 2022-08-14 13:00:31-07:00
description: In which I write a Raku emoji reverse lookup tool.
draft: false
posse:
- https://hackers.town/@randomgeek/108823061585109635
- https://twitter.com/brianwisti/status/1558910392390193157
tags:
- raku-lang
