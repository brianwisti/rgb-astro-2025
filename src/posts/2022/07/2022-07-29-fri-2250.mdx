...
Used [CogDB](https://cogdb.io) to describe a folder hierarchy. Easier than figuring out how to
annotate recursive structures for [Mypy](https://mypy-lang.org).
...
Okay _fine_. Here's a cleaned-up version of the code looking at my [main blog](https://randomgeekery.org)
Markdown sources.
