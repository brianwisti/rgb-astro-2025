...
categories:
- post
cover_caption: histogram for post frequency by year using Nushell built-ins
cover_image: /img/2022/cover-my-three-ish-favorite-nushell-features.png
date: 2022-07-04 18:00:00-07:00
description: Six if you insist on using math
draft: false
posse:
- https://hackers.town/@randomgeek/108592201010750028
- https://twitter.com/brianwisti/status/1544135429363929093
tags:
- nushell
- hugo
...
Been using the [Nushell][nushell] cross-platform user shell more and more over the last couple years.
Might as well start learning it.
...
[nushell-windows-post]: /post/2022/04/trying-nushell-on-windows/
...
![output of command is a dense blast of CSV text](@img/2022/hugo-list-all.png "Yep that's CSV all right.")
...
![screenshot of nushell table display of hugo articles](@img/2022/from-csv.png "It's pretty. Just needs a little tidying up.")
...
![initial tab-completion display of functions available in Nushell](@img/2022/nushell-tab.png "or hit TAB on a blank line")
...
![all of the Nushell command categories](@img/2022/group-by-category.png "Not sorted or anything, but you get the idea")
...
![a table of commands in the "formats" category](@img/2022/format-commands.png "`to md`? Interesting!")
...
![screenshot of Nushell builtin help, with usage, flags, and examples](@img/2022/help-to-md.png "syntax highlighted examples? yes please")
...
Nushell blocks look and work a bit like Ruby blocks.
That means they also work similar to lambdas in Python and anonymous functions in other languages —
cosmetic and shell-specific details aside.
