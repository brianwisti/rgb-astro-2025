...
- /post/2007/04/python-interactive-fiction-01-handling-a-single-round/
categories:
- post
...
::note{title="Warning"}
Please don't explore this with other types of bad input. You could end up with a Python process that won't quit unless youforce it to quit from your task / process manager.
:::
