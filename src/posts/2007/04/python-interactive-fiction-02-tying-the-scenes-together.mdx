...
This is the second part of an [ongoing series](/post/2007/04/interactive-fiction-with-python/) about using
Python to create interactive fiction.  I hope to show you one fun use of
Python while teaching you more about the basics of this language.  We [started](/post/2007/04/interactive-fiction-with-python/)
by defining how our game was going to work and creating a
set of scenes for play. [Next](/post/2007/04/python-interactive-fiction-01-handling-a-single-round/) we wrote the code to handle
