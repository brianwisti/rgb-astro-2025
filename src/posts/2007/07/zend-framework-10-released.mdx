...
- /post/2007/07/zen-framework-10-released/
categories:
- post
...
PHP may not be my favorite language, but the last couple of years have seen profound improvement.
I got the urge to start playing with [Zend Framework](http://framework.zend.com/) last week.
It isn't too shabby.
Yesterday Zend made a [1.0 release](http://devzone.zend.com/article/2262-Zend-Framework-1.0.0-production-release),
which is a good milestone for PHP types to learn about MVC and ACLs etc.
You know, other than the ones who are already using [CakePHP](http://cakephp.org/).
