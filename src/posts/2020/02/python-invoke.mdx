...
[Jeff Forcier](https://bitprophet.org/) for this unified approach.
...
the [task
decorator](https://docs.pyinvoke.org/en/stable/api/tasks.html#invoke.tasks.task)
...
[context](https://docs.pyinvoke.org/en/stable/api/context.html). We’ll
...
you’ve added
[parameters](https://docs.pyinvoke.org/en/stable/getting-started.html#task-parameters)
to the task.
...
run](https://docs.pyinvoke.org/en/stable/concepts/invoking-tasks.html#how-tasks-run)
...
[context](https://docs.pyinvoke.org/en/stable/api/context.html) object\!
Invoke’s context holds details about the environment our tasks run in.
Most important for today, they give us a way to
[run](https://docs.pyinvoke.org/en/stable/api/context.html#invoke.context.Context.run)
shell commands.
...
Technically a
[Runner](https://docs.pyinvoke.org/en/stable/api/runners.html#invoke.runners.Runner)
