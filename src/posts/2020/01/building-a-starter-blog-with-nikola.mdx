...
- /post/2020/01/building-a-starter-blog-with-nikola/
categories:
- post
cover_image: /img/2020/cover-building-a-starter-blog-with-nikola.png
...
[Cleaning]: /post/2019/12/removing-mmark-has-me-grumbly/
...
![screenshot of site header and footer](@img/2020/01-empty-site.png "The empty site")
...
![screenshot of page with post content](@img/2020/02-index-with-post.png "Index page with one post")
...
![screenshot with truncated post content](@img/2020/index-with-teaser.png "Index page with teaser")
...
![screenshot with post content with metadata](@img/2020/03-post.png "The post itself")
...
![screenshot of /now page](@img/2020/now.png "The Now page")
