...
- /post/2020/01/taskwarrior-sync/
categories:
- post
cover_caption: '[inthe.AM](https://inthe.am) is pretty, that''s for sure.'
cover_image: /img/2020/cover-taskwarrior-sync.png
...
:::note{title="Why not just use your phone?"}
...
![freecinc.com](@img/2020/freecinc.png)
...
![inthe.AM Web interface](@img/2020/inthe-am.png)
...
![Trello showing my active tasks](@img/2020/inthe-am-trello.png)
...
![The first couple steps of Freecinc setup](@img/2020/freecinc-setup.png)
...
[crontab guru](https://crontab.guru/#0_*****_*) says "hourly"
