...
- /post/2020/01/a-quick-notes-script-for-taskwarrior/
categories:
- post
cover_image: /img/2020/cover-a-quick-notes-script-for-taskwarrior.png
...
![Neovim launched by Python](@img/2020/task-notes-view.png)
