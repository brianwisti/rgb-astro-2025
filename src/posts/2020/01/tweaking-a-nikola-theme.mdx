...
- /post/2020/01/tweaking-a-nikola-theme/
categories:
- post
cover_caption: The [/now](/now) page, in Nikola
cover_image: /img/2020/cover-tweaking-a-nikola-theme.png
...
```yaml title="posts/2019/12/again-with-the-manual-symmetry/index.md"
---
...
Keep in mind what I noticed [the other day][rst-basics] about these not being
real figures in reStructuredText. For now I match RST output, as if I’d used a
[figure directive][rst-figure]. That way I don’t have to find the CSS for this
theme.

[rst-basics]: /post/2020/01/restructuredtext-basics-for-blogging/
[rst-figure]: https://docutils.sourceforge.io/docs/ref/rst/directives.html#figure

![screenshot showing cover image in post](@img/2020/cover-in-post.png "Cover image in post")

It has a cover image, placed right by the title. It doesn’t *quite* match
today’s view of [that post][manual-symmetry], but this has the basic idea. And
I only had to edit a single template file!

[manual-symmetry]: /post/2019/12/again-with-the-manual-symmetry/

![screenshot of same page with different style](@img/2020/post-hugo-comparison.png "The same page on the current site")

Looks good for posts that have a cover image. How about pages?

![screenshot of /now page with nikola style](@img/2020/cover-in-page.png "Cover image in a non-post page")
...
![screenshot with large jumbotron element](@img/2020/post-previewimage-jumbotron.png "Cover image in Bootstrap Jumbotron")
