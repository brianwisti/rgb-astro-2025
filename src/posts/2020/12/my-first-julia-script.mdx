---
aliases:
- /post/2020/12/my-first-julia-script/
categories:
- post
cover_caption: Drawn with [Luxor.jl](http://juliagraphics.github.io/Luxor.jl/stable/)
cover_image: /img/2020/cover-my-first-julia-script.png
date: 2020-12-25 00:00:00-08:00
description: Weaving code in Hugo posts with Julia
draft: false
posse:
- https://hackers.town/@randomgeek/105443065345953821
tags:
- julialang
...
[literate programming]: https://web.archive.org/web/20241216123027/http://www.literateprogramming.com/
...
[chunk options]: https://weavejl.mpastell.com/stable/chunk_options/
...
[Luxor]: https://juliagraphics.github.io/Luxor.jl/stable/
