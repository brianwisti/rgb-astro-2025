...
draft: false
posse:
- https://hackers.town/@randomgeek/105410183905946454
tags:
- lisp
- emacs
- org
...
Org mode is more interesting to me.  I could make my [config][config] smarter.  For
...
[xah-lee]: https://web.archive.org/web/20240907173054/http://xahlee.info/emacs/emacs/elisp_get_user_input.html
