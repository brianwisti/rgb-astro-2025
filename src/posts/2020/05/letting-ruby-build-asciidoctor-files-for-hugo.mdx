...
categories:
- post
cover_caption: actually really proud of myself but this post needs all the disclaimers
cover_image: /img/2020/cover-letting-ruby-build-asciidoctor-files-for-hugo.jpg
date: 2020-05-18 14:15:00-07:00
description: Stuff like this is why i don't advertise my site repo
draft: false
posse:
- https://hackers.town/@randomgeek/104191542874551454
- https://twitter.com/brianwisti/status/1262493428023246848
tags:
- ruby
- hugo
- site
...
![screenshot showing image shortcode instead of an image](@img/2020/escaped-shortcode.png "my shortcode got escaped")
...
![correct shortcode](@img/2020/correct-shortcode.png "using a passthrough macro")
...
[grumbly]: /post/2019/12/removing-mmark-has-me-grumbly/
