---
aliases:
- /post/2020/05/got-a-working-glitch-soc-rails-dev-environment/
categories:
- post
cover_image: /img/2020/cover-got-a-working-glitch-soc-rails-dev-environment.png
date: 2020-05-04 23:26:21-07:00
description: I remain ambivalent about Rails development
draft: false
posse:
- https://hackers.town/@randomgeek/104114425728242985
- https://twitter.com/brianwisti/status/1257557744346955776
tags:
- rails
- mastodon
- ruby
...
Adding a task to look more closely at [microformats-ruby][microformats-ruby].  It’s more active
than [mf2py][].
