...
posse:
  - https://hackers.town/@randomgeek/103864261442692092
tags:
  - site
  - helpful-hint
...
Gave them all a Universally Unique Identifer, per [RFC 4122][rfc-4122].
...
[uuidgen](https://bigdatums.net/2016/10/01/generate-uuid-linux/) command
