...
- /post/2020/04/getting-filte-info-from-the-shell/
categories:
- post
cover_caption: also, it is time to vacuum my desk again
cover_image: /img/2020/cover-getting-file-info-from-the-shell.jpg
date: 2020-04-21 15:11:17-07:00
description: I could right click for properties but the mouse is way over there
draft: false
posse:
- https://hackers.town/@randomgeek/104038902820824748
tags:
- files
- shell
- exiftool
...
![grubby scary basement](@img/2020/basement-original.jpg
