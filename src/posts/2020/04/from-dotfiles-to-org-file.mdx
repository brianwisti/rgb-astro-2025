...
categories:
  - post
cover_image: /img/2020/cover-from-dotfiles-to-org-file.png
date: 2020-04-28 01:36:54-07:00
description: at 1:30am they're all good ideas
draft: false
posse:
  - https://hackers.town/@randomgeek/104075340897518607
tags:
  - second-brain
uses:
  - org
...
:::note{title="2020-05-09 Correction"}
...
:::note{title="Emacs code extraction key bindings"}

| Key         | Function           | Action                                            |
| ----------- | ------------------ | ------------------------------------------------- |
| `C-c C-v t` | `org-babel-tangle` | Extract and write code blocks in current Org file |
