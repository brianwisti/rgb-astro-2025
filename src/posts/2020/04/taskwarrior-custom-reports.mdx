...
categories:
- post
cover_caption: output of my custom `task top` report
cover_image: /img/2020/cover-taskwarrior-custom-reports.png
...
draft: false
posse:
- https://hackers.town/@randomgeek/104086499493510887
- https://twitter.com/brianwisti/status/1255770866375372800
series:
...
[task-active]: /post/2018/12/active-tasks-in-taskwarrior/

{% note title="Yeah I know" %}
Taskwarrior lets you assign [due dates][due-dates] and
[dependencies][dependencies] . Tasks that are due or that block something else
get higher `Urgency`, and bubble to the top of reports. For some folks, that
works great.
...
I still use [`start`][task-active] to remember what I’m doing right now though. I’m not
completely weird.
{% /note %}
