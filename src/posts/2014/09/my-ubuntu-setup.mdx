...
- [GNU Emacs](http://www.gnu.org/software/emacs/) because it's become my default text editor.
...
- [rvm](http://rvm.io) for [Ruby](https://www.ruby-lang.org/en/), along with whatever gets installed by `rvm requirements`
