...
- /post/2014/08/trusty-mongo-mojo-box/
categories:
- post
date: 2014-08-05 00:00:00-07:00
posse:
- https://twitter.com/brianwisti/status/496796921269198848
tags:
- virtualization
- vagrant
- perl
...
```bash title="Bootstrap/system.sh"
#!/bin/bash
...
The Vagrant [package command](http://docs.vagrantup.com/v2/cli/package.html) takes your
