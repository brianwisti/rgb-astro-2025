...
- /post/2010/03/php-buzz-stream-reader/
categories:
- post
...
![Google Buzz Widget Image](@img/2010/buzz-widget.png "Google Buzz Widget Image")
...
![Google Buzz dumped image](@img/2010/buzz-dump.png "Google Buzz dumped image")
...
of my Buzz debug run into the page.
Wonder if I could find a capture at https://archive.org
:::
