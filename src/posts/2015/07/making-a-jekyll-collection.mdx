...
posse:
- https://twitter.com/brianwisti/status/622878343470256128
tags:
- jekyll
- site
- tools
...
```markdown title="crafts/garter-scarf-wrapped.md"
---
...
![Voila!](@img/2015/crafts-project.png)
...
![A short and sweet summary](@img/2015/crafts-summary-01.png)
...
![Listing every project](@img/2015/crafts-summary-02.png)
...
![Just the newest projects please](@img/2015/crafts-summary-03.png)
...
![Short and sweet version of the crafts index](@img/2015/crafts-index.png)
...
```liquid title="crafts/index.html" {% process=false %}
{% assign projects = site.crafts | sort: 'finished' | reverse %}
{% for project in projects %}
  {% assign year_finished = project.finished | date: "%Y" %}
  {% if year_finished != year %}
...
![Final version of the crafts summary](@img/2015/crafts-summary-04.png)
