...
- /post/2015/07/remote-editing-in-atom/
categories:
- post
...
Palette](@img/2015/remote-atom-start-server.png)
...
![Stop Server from the Command Palette](@img/2015/remote-atom-stop-server.png)
